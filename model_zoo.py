...
# ======================================================================
# 2D Unet for image to image translation (the generator network for the cycle gan)
# ======================================================================
def generator(images,
    ...
    with tf.variable_scope(scope_name) as scope:
        ...
        # ====================================
        # Final conv layer - without batch normalization
        # ====================================
        transformed_images = layers.conv2D_layer(x=conv7_2, name='output_layer', num_filters=1, kernel_size=3, activation=tf.nn.relu)
